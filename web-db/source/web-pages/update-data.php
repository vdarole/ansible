...
$sql_query = "INSERT INTO emp_details (f_name,l_name,gender,email,mobile,dob,address,a_qualification,g_certification,y_experience,c_company,l_company,location,n_period,h_technology) VALUES ('$f_name','$l_name','$gender','$email','$mobile','$dob','$address','$a_qualification','$g_certification','$y_experience','$c_company','$l_company','$location','$n_period','$h_technology')" ;
